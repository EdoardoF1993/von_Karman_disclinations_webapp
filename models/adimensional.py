...
class ToyPlateFVK:
    def __init__(self, mesh, model_parameters = {}) -> None:
        self.alpha_penalty =100 # model_parameters.get("alpha_penalty", default_model_parameters["alpha_penalty"])
...
class A_NonlinearPlateFVK(ToyPlateFVK):
    ...
    def __init__(self, mesh, model_parameters = {}, smooth=False) -> None:
        self.alpha_penalty = 100 #model_parameters.get("alpha_penalty", default_model_parameters["alpha_penalty"])
        self.nu = 0.15 #model_parameters.get("nu", default_model_parameters["nu"])
        self.E = 1000000 #model_parameters.get("E", default_model_parameters["E"])
        self.t = 0.1 #model_parameters.get("thickness", default_model_parameters["thickness"])
